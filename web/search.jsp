<%-- 
    Document   : search
    Created on : Jun 12, 2017, 12:20:30 PM
    Author     : User
--%>

<%@page import="rcpl.searchbean"%>
<%@page import="java.sql.PreparedStatement"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@taglib uri="http://struts.apache.org/tags-html" prefix="s" %>
<%@taglib uri="http://struts.apache.org/tags-bean" prefix="h" %>
...
<html>
    <head>
        ...
        <style>
body {
    background-image: url("airplane-wallpaper-24.jpg");
    margin:0;}
...
.table-hover .table-danger:hover > th {
 ...
 <div class="topnav">
  ...
  <a href="index.jsp">LogOut</a>
        ...
        <br>
        <br>
        <table class="active1" border="5" border-style: solid
    border-color: orange align="center">
            <td>
                
                <form action= "search.jsp" method="post">
        <table class ="active1" align="center" cellspacing="15">
            <tr bgcolor="orange">
      ...
      <% String source5 = request.getParameter("source1"); %>
      <% String source6 = request.getParameter("destination1"); %>
      <% String source7 = request.getParameter("date1"); %>
